...
export type FilterType = "text" | "date" | "number" | "select" | "boolean";
...
export const INWARD_GATE_ENTRY_COLUMNS: ColumnConfig[] = [
  { id: "Entry_Type", label: "Entry Type", sortable: true, filterType: "select", options: [{ label: "Inward", value: "Inward" }] },
