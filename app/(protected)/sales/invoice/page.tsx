...
import { SalesInvoiceView } from "@/components/forms/sales-orders/sales-invoice-view";
import { Tabs, TabsContent, TabsList, TabsTrigger } from "@/components/ui/tabs";

type SalesInvoiceTab = "open" | "pending" | "approved";
...
function SalesInvoicePageContent() {
  ...
  const [activeTab, setActiveTab] = useState<SalesInvoiceTab>("open");
  ...
  return (
    <div className="flex h-[calc(100vh-5rem)] max-h-[calc(100vh-5rem)] w-full">
      <div className="flex min-w-0 flex-1 flex-col">
        <Tabs
          value={activeTab}
          onValueChange={(t) => setActiveTab(t as SalesInvoiceTab)}
