...
interface QCReceiptColumnFilterProps {
  column: ColumnConfig;
  value: string;
  valueTo?: string;
...
export function QCReceiptColumnFilter({
  column,
  value,
  valueTo,
  onChange,
}: QCReceiptColumnFilterProps) {
  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        <button
          type="button"
          className={`hover:bg-background/50 ml-1 rounded p-0.5 transition-colors ${
            hasFilter
              ? "text-primary"
