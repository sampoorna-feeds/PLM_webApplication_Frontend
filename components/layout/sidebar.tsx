...
const formsItems = [
  { title: "Production Order", url: "/production-orders", icon: FileText },
];
                  ...
                  <SidebarMenuItem>
                    <CollapsibleTrigger asChild>
                      ...
                      >
                        <FileText />
                        <span>Sales</span>
                        <ChevronDown className="ml-auto size-4 group-data-[state=open]/collapsible:rotate-0 group-data-[state=closed]/collapsible:-rotate-90" />
                      </SidebarMenuButton>
                    </CollapsibleTrigger>
                  </SidebarMenuItem>
                  <CollapsibleContent>
