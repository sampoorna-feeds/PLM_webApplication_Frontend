 ...
 * Replicated from the sales order form so credit-memo-specific logic can diverge.
 */
...
export function SalesCreditMemoForm({
  tabId,
  formData: initialFormData,
  context,
}: SalesCreditMemoFormProps) {
  ...
  const onSuccess = (orderNo: string) => {
    ...
    markAsSaved();
    onOrderPlaced?.();
    const detailTabId = openTab("sales-credit-memo-detail", {
      title: `Order ${orderNo}`,
