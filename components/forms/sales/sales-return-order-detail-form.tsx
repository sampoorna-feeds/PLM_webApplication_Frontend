...
import { SalesReturnOrderItemTrackingDialog } from "@/components/forms/sales/sales-return-order-item-tracking-dialog";
import { SalesReturnOrderLineDialog } from "@/components/forms/sales/sales-return-order-line-dialog";
import {
  Table,
  TableBody,
  TableCell,
...
interface SalesReturnOrderDetailFormProps {
  tabId: string;
...
export function SalesReturnOrderDetailForm({
  tabId,
  context,
}: SalesReturnOrderDetailFormProps) {
  ...
  return (
    <>
      ...
      <div className="flex flex-col gap-6 px-6 py-4">
        ...
        <SalesReturnOrderItemTrackingDialog
