 ...
 * Replicated from the purchase order form so invoice-specific logic can diverge.
 */
...
import {
  ...
  type PurchaseInvoiceData as PurchaseOrderData,
  type PurchaseInvoiceLineItem as PurchaseOrderLineItem,
...
export function PurchaseOrderFormContent({
  ...
  const handleCreateOrderHeader = async () => {
    ...
    try {
      const orderResponse = await createPurchaseInvoice(buildOrderData());
  ...
  const handlePlaceOrder = async () => {
    ...
    try {
      ...
      await addPurchaseInvoiceLineItems(
        createdOrderNo,
        lineItemsData,
        locationCode,
      );
