...
async function getPaginatedSourceDocs(
  ...
  if ($orderby) {
    ...
    allResults.sort((a, b) => {
      ...
      if (field === "Posting_Date" || field === "Document_Date") {
        valA = valA || a.Posting_Date || a.Document_Date || a.Order_Date || a["Document Date"] || "";
        valB = valB || b.Posting_Date || b.Document_Date || b.Order_Date || b["Document Date"] || "";
