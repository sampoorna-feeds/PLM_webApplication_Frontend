...
interface OutwardGateEntryColumnFilterProps {
  column: ColumnConfig;
  value: string;
  valueTo?: string;
...
export function OutwardGateEntryColumnFilter({
  column,
  value,
  valueTo,
  onChange,
}: OutwardGateEntryColumnFilterProps) {
  ...
  useEffect(() => {
    ...
    // Parse operator from value if it's a number filter
