...
export const DEFAULT_COLUMNS: ColumnConfig[] = [
  ...
  },
  {
    ...
    filterOptions: [
      ...
      { value: "Positive Adjmt.", label: "Positive Adjmt." },
      { value: "Negative Adjmt.", label: "Negative Adjmt." },
...
export const OPTIONAL_COLUMNS: ColumnConfig[] = [
  ...
  // ── Document / Order ──
  {
    ...
    filterOptions: [
      ...
      { value: "Sales Credit Memo", label: "Sales Credit Memo" },
      { value: "Purchase Receipt", label: "Purchase Receipt" },
      { value: "Purchase Invoice", label: "Purchase Invoice" },
      { value: "Purchase Return Shipment", label: "Purchase Return Shipment" },
      { value: "Purchase Credit Memo", label: "Purchase Credit Memo" },
