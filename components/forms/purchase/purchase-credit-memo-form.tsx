 ...
 * Replicated from the purchase order form so credit-memo-specific logic can diverge.
 */
...
import {
  ...
  type PurchaseCreditMemoData as PurchaseOrderData,
  type PurchaseCreditMemoLineItem as PurchaseOrderLineItem,
...
export function PurchaseOrderFormContent({
  ...
  const handleCreateOrderHeader = async () => {
    ...
    try {
      const orderResponse = await createPurchaseCreditMemo(buildOrderData());
  ...
  const handlePlaceOrder = async () => {
    ...
    try {
      ...
      await addPurchaseCreditMemoLineItems(
        createdOrderNo,
        lineItemsData,
        locationCode,
      );
