...
import { SalesInvoiceItemTrackingDialog } from "@/components/forms/sales/sales-invoice-item-tracking-dialog";
import { SalesInvoiceLineDialog } from "@/components/forms/sales/sales-invoice-line-dialog";
import {
  Table,
  TableBody,
  TableCell,
...
export function SalesInvoiceDetailForm({
  tabId,
  context,
}: SalesInvoiceDetailFormProps) {
  ...
  return (
    <>
      ...
      <div className="flex flex-col gap-6 px-6 py-4">
        ...
        <SalesInvoiceItemTrackingDialog
