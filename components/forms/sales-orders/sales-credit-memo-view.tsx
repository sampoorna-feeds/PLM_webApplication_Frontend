...
} from "./use-sales-credit-memos";

export interface SalesCreditMemoViewProps {
...
export function SalesCreditMemoView({
  statusFilter,
  onPlaceOrder,
  registerRefetch,
}: SalesCreditMemoViewProps) {
      ...
      <div className="flex min-h-0 flex-1 flex-col gap-2">
        ...
        <div className="min-h-0 flex-1 overflow-hidden">
          <SalesOrdersTable
            ...
            columnFilters={columnFilters}
            onRowClick={(orderNo) => {
              openTab("sales-credit-memo-detail", {
                title: `Order ${orderNo}`,
