...
import { SalesCreditMemoView } from "@/components/forms/sales-orders/sales-credit-memo-view";
import { Tabs, TabsContent, TabsList, TabsTrigger } from "@/components/ui/tabs";

type SalesCreditMemoTab = "open" | "pending" | "approved";
...
function SalesCreditMemoPageContent() {
  ...
  const [activeTab, setActiveTab] = useState<SalesCreditMemoTab>("open");
  ...
  return (
    <div className="flex h-[calc(100vh-5rem)] max-h-[calc(100vh-5rem)] w-full">
      <div className="flex min-w-0 flex-1 flex-col">
        <Tabs
          value={activeTab}
          onValueChange={(t) => setActiveTab(t as SalesCreditMemoTab)}
