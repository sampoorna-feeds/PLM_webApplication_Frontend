/**
 * Sales Return Order API Service
 * Handles creating sales return orders and managing return order lines.
 */
...
/** Create a minimal sales return order header for the Copy Document flow. */
export async function createSalesReturnOrderCopyHeader(
  locationCode: string,
  lobCode: string,
  branchCode: string,
): Promise<CreateSalesDocumentResponse> {
...
/** Add multiple line items to a return order in sequence. */
export async function addSalesReturnOrderLineItems(
  documentNo: string,
...
/** Add a single line to an existing return order. */
export async function addSingleSalesReturnOrderLine(
  documentNo: string,
...
/** Update an existing return order line. */
export async function updateSingleSalesReturnOrderLine(
  documentNo: string,
  lineNo: number,
...
/** Delete a single return order line. */
export async function deleteSingleSalesReturnOrderLine(
  documentNo: string,
  lineNo: number,
): Promise<void> {
