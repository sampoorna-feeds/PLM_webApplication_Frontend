...
export function OutwardGateEntryColumnVisibility({
  visibleColumns,
  defaultColumns,
  optionalColumns,
  onColumnToggle,
  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        <Button variant="outline" size="sm" className="gap-2 h-9 text-[10px] font-bold uppercase tracking-wider">
      ...
      <PopoverContent className="w-56 p-0" align="end">
        <div className="border-b p-3">
          <div className="flex items-center justify-between">
            <span className="text-[10px] font-bold uppercase tracking-wider">Toggle Columns</span>
