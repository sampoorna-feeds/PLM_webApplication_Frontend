import { ColumnConfig, ALL_COLUMNS } from "../column-config";

export interface QCReceiptFilterParams {
...
export function buildQCReceiptFilterString(
  params: QCReceiptFilterParams,
): string | undefined {
