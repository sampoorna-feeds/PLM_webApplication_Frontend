 ...
 * Replicated from the sales order form so return-order-specific logic can diverge.
 */
...
export function SalesReturnOrderForm({
  tabId,
  formData: initialFormData,
  context,
}: SalesReturnOrderFormProps) {
  ...
  const onSuccess = (orderNo: string) => {
    ...
    markAsSaved();
    onOrderPlaced?.();
    const detailTabId = openTab("sales-return-order-detail", {
      title: `Order ${orderNo}`,
