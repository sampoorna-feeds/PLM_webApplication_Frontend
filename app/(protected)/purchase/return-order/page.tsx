...
import { PurchaseReturnOrderView } from "@/components/forms/purchase-orders/index";
...
function PurchaseReturnOrderPageContent() {
            ...
            <div className="flex items-center justify-between">
              <div>
                <h1 className="text-2xl font-semibold tracking-tight">
                  Purchase Return Memos
                </h1>
                <p className="text-muted-foreground text-sm">
                  Manage and track return memos
                </p>
              </div>
...
export default function PurchaseReturnOrderPage() {
  return (
    <FormStackProvider formScope="purchase">
      <PurchaseReturnOrderPageContent />
    </FormStackProvider>
  );
}
