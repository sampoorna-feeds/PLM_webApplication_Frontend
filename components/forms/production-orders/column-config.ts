...
export const DEFAULT_COLUMNS: ColumnConfig[] = [
  ...
  { id: 'Description', label: 'Description', sortable: true, defaultVisible: true, filterType: 'text' },
  { id: 'Source_No', label: 'Source No', sortable: true, defaultVisible: true, filterType: 'text' },
  { id: 'Quantity', label: 'Quantity', sortable: true, defaultVisible: true, filterType: 'number' },
  { id: 'Location_Code', label: 'Location', sortable: true, defaultVisible: true, filterType: 'text' },
  { id: 'Last_Date_Modified', label: 'Last Modified', sortable: true, defaultVisible: true, filterType: 'date' },
];

// Optional columns - can be toggled by user
export const OPTIONAL_COLUMNS: ColumnConfig[] = [
  { id: 'Status', label: 'Status', sortable: true, defaultVisible: false, filterType: 'enum' },
  { id: 'Source_Type', label: 'Source Type', sortable: true, defaultVisible: false, filterType: 'enum' },
  { id: 'Description_2', label: 'Description 2', sortable: true, defaultVisible: false, filterType: 'text' },
  { id: 'Search_Description', label: 'Search Description', sortable: true, defaultVisible: false, filterType: 'text' },
  { id: 'Supervisor_Name', label: 'Supervisor', sortable: true, defaultVisible: false, filterType: 'text' },
  { id: 'Due_Date', label: 'Due Date', sortable: true, defaultVisible: false, filterType: 'date' },
  { id: 'Blocked', label: 'Blocked', sortable: true, defaultVisible: false, filterType: 'boolean' },
  { id: 'Hatching_Date', label: 'Hatching Date', sortable: true, defaultVisible: false, filterType: 'date' },
  { id: 'Prod_Bom_No', label: 'Prod BOM No', sortable: true, defaultVisible: false, filterType: 'text' },
  { id: 'BOM_Version_No', label: 'BOM Version', sortable: true, defaultVisible: false, filterType: 'text' },
  { id: 'Batch_Size', label: 'Batch Size', sortable: true, defaultVisible: false, filterType: 'text' },
