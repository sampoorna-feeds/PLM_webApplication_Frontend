...
import { type PostedPurchaseHeader } from "@/lib/api/services/posted-purchase.service";
...
export function PostedPurchaseTable({
  ...
  const columns = [
    { id: "No", label: "No." },
    { id: "Buy_from_Vendor_No", label: "Vendor No." },
    { id: "Buy_from_Vendor_Name", label: "Vendor Name" },
