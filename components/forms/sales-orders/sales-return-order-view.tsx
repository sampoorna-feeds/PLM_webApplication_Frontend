...
} from "./use-sales-return-orders";

export interface SalesReturnOrderViewProps {
...
export function SalesReturnOrderView({
  statusFilter,
  onPlaceOrder,
  registerRefetch,
}: SalesReturnOrderViewProps) {
      ...
      <div className="flex min-h-0 flex-1 flex-col gap-2">
        ...
        <div className="min-h-0 flex-1 overflow-hidden">
          <SalesOrdersTable
            ...
            columnFilters={columnFilters}
            onRowClick={(orderNo) => {
              openTab("sales-return-order-detail", {
                title: `Order ${orderNo}`,
